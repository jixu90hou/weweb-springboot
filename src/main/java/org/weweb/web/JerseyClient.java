...
public class JerseyClient {
	...
	public static void main(String[] args) {
		...
		SessionState.Client client = SessionState.Client.create(cc);
		...
		String str = resource.accept(MediaType.TEXT_PLAIN).type(MediaType.TEXT_PLAIN).get(String.class);
		...
		// header方法可用来添加HTTP头
		ClientResponse response = resource.header("auth", "123456").accept(MediaType.TEXT_PLAIN)
